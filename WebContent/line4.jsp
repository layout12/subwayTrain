...
<body style="background-image: url(img/line4.jpg);">
	
	<section style="width: 1900px;">
	<div class="box">
		<div class="img"><img align="left" alt="국립중앙박물관" src="img/lineImg/lineFour-1.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;국립중앙박물관<a href="#" onclick="shortestDView('이촌'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			국립중앙박물관은 22만 점의 소장유물을 소장하고 있으며, 고고, 역사, 미술, 기증,
			아시아 관련 문화재를 전시하는 상설 전시실과 다양한 전시가 가능하도록 가변성 있게 구성된 기획 전시실, 
			체험과 참여 학습을 통해 전시를 이해하도록 설계된 어린이 박물관, 박물관 야외정원을 이용하여 석탑 등 다양한 석조유물을 전시한 야외전시실로 이루어져 있습니다.
			이촌역 2번출구로 가면 편리합니다.
			</p>
		</div>
	...
	<div class="box">
		<div class="img"><img align="right" alt="서울대공원" src="img/lineImg/lineFour-2.png" class="lineImg"></div>
		<div class="text">
			<h1 class="contentTitle">&nbsp;&nbsp;&nbsp;서울대공원<a href="#" onclick="shortestDView('대공원'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent" style="padding-left: 15px;">
			세계 각국의 야생동물들이 살아 숨 쉬는 서울동물원과 다양한 재미와 즐거움을 주는 서울랜드, 자연과 사람의 특별한 이야기가 있는 테마가든, 자연의 소중함을 배우는 서울대공원 캠핑장,
			신나는 어린이 체험놀이터 기린나라 그리고 근·현대 미술계의 흐름을 한눈에 볼 수 있는 국립현대미술관으로 구성되어 있으며 많은 시민들의 추억과 사랑을 한 몸에 받고 있는 대한민국 대표 종합 테마파크입니다.
			대공원역 2번출구에 있습니다.
			</p>
		</div>
	</div>
	...
	<div class="box">
		<div class="img"><img align="left" alt="정돈" src="img/lineImg/lineFour-3.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;정돈<a href="#" onclick="shortestDView('혜화'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			혜화역 3번출구에 위치하고 있는 돈까스 전문점 ‘정돈’입니다.<br>
			전용 숙성고에서 400시간 숙성시킨 최고급 국내산 돼지고기로만 돈까스를 만들고 있습니다.<br>
			두툼하고 육즙이 배어나오는 담백한 등심돈까스와 촉촉하고 부드러운 안심돈까스, 
			그리고 워머에 올려져 식지않게 식사할 수 있는 전통 일본식 카레와 탱글탱글한 새우튀김을 맛볼 수 있습니다.
			</p>
		</div>
	</div>
