...
<script src="resources/menu.js?ver=1"></script>
<script type="text/javascript">
	...
	function writeDelete(){
		...
		if(tf){
			location.href = "metroCon.do?command=writeDelete&writeNo=${map.dto.writeNo }&role=ADMIN";	
		}
	}
...
<body>
	...
	<div id="wrap">		
		...
		<ul class="dtlBtns">
			<li><input type="button" value="목록" class="btnBase01" onclick="location.href='metroCon.do?command=noticeList&role=ADMIN&rowNo=${param.rowNo}'"></li>
			<li><button class="btnBase01" onclick="roleCheck('up')">수정</button></li>
			<li><button class="btnBase02" onclick="roleCheck('del')">삭제</button></li>
		</ul>
		<!--공지사항 테이블  -->
			...
			<table id="com">
				...
				<c:forEach items="${map.list }" var="dto">
					<tr>
						...
						<form action="metroCon.do" method="post" id="cUpdate">
