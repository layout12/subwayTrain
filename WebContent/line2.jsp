...
<body style="background-image: url(img/line2.jpg);">
	
	<section style="width: 1900px;">
	<div class="box">
		<div class="img"><img align="left" alt="이한열 기념관" src="img/lineImg/lineTwo-1.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;이한열 기념관<a href="#" onclick="shortestDView('신촌'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			신촌역에 위치한 이한열기념관은 이한열 열사의 유품을 비롯한 1987년 유월항쟁의 기록을 보존하고, 연구하며, 전시를 통해 민주주의의 역사를 교육하는 박물관입니다.
			열사의 어머니가 국가로부터 받은 배상금과 시민 성금으로 2004년에 세워졌으며, 2014년 사립박물관으로 새롭게 개관하였습니다. <br/>
			[관람은 홈페이지 예약 : 월~금 10~17시]<br/>
			</p>
		</div>
	...
	<div class="box">
		<div class="img"><img align="right" alt="서울대 입구역" src="img/lineImg/lineTwo-2.png" class="lineImg"></div>
		<div class="text">
			<h1 class="contentTitle">&nbsp;&nbsp;&nbsp;돈뼈락 연탄갈비<a href="#" onclick="shortestDView('서울대입구'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent" style="padding-left: 15px;">
			서울대입구역 8번출구에 위치한 맛집으로 전국 3대 돼지갈비 중 한 곳입니다. <br/>
			연탄불에 초벌된 돼지갈비의 깊은 맛을 맛볼 수 있는 오랜 전통이 있는 돼지갈비집입니다. <br/>
			</p>
		</div>
	</div>
	
	<div class="box">
		<div class="img"><img align="left" alt="이대역" src="img/lineImg/lineTwo-3.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;이화여자대학교<a href="#" onclick="shortestDView('이대'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			우리나라 최고의 여성명문대학인 이화여자대학교는 이대역 3번 출구에 위치합니다. <br/>
			이대의 명물로 손꼽히는 이화캠퍼스 복합단지는 국내 대학 최대 규모로 다양한 교육,복지,문화시설을 갖춘 인공 계곡 형태로 친환경 기술과 디자인을 감상할 수 있습니다. <br/>
			</p>
		</div>
	</div>
