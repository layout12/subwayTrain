...
<body style="background-image: url(img/line9.jpg);">
	
	<section style="width: 1900px;">
	<div class="box">
		<div class="img"><img align="left" alt="허준박물관" src="img/lineImg/lineNine-1.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;허준박물관<a href="#" onclick="shortestDView('가양'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			동의보감(국보 제319호)을 쓴 허준 선생의 모든 것을 만날 수 있는 곳입니다.<br>
			허준 기념실, 동의보감실, 약초약제실, 의약기실, 어린이체험실, 내의원과 한의원실에서<br>
			열리는 다양한 생사에 직접 참여하고 체험할 수 있습니다. <br>
			</p>
		</div>
	...
	<div class="box">
		<div class="img"><img align="right" alt="국립서울현충원" src="img/lineImg/lineNine-2.png" class="lineImg"></div>
		<div class="text">
			<h1 class="contentTitle">&nbsp;&nbsp;&nbsp;국립서울현충원<a href="#" onclick="shortestDView('동작'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent" style="padding-left: 15px;">
			국립 서울 현충원은 국가와 민족을 위해 목숨을 바친 전사 또는 순직군인과 군무원,<br>
			국가원수, 애국지사, 순국선열을 비롯한 국가유공자, 경찰관, 전투에 참여한 향토예비군들이 안장된 곳입니다.<br>
			봄에는 벚꽃들이 잔뜩 흐드러져 가족들, 연인들이 나들이로 방문하곤 합니다.
			</p>
		</div>
	</div>
	
	<div class="box">
		<div class="img"><img align="left" alt="호우 초밥" src="img/lineImg/lineNine-3.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;호우 초밥<a href="#" onclick="shortestDView('신논현'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			가성비 좋은 강남역 초밥집으로 유명합니다.<br>
			강남에서 두툼하고 신선한 초밥을 먹고 싶다면 호우 초밥 어떨까요?<br>
			매주 월요일에 휴무이며 오후 3시부터 4시까지 브레이크타임입니다.<br>
			</p>
		</div>
	</div>
