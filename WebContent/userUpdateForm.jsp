		...
		<div id="memberWrap3">
			...
			<div id="tbWrapUp">
				<table>
					...
					<tr>
						<th>비밀번호</th>
						<td><input name="password" type="password" style="color: red" value="${dto.password }"></td>
						<!-- <td><input type="password" name="pw" value="ㆍㆍㆍㆍㆍㆍㆍ"></td> -->
					</tr>
					<tr>
						<th>이름</th>
						<td>${dto.name }</td>
					...
					<tr>
						<th>닉네임</th>
						<td><input name="nickName" type="text" value="${dto.nickname }"></td>
					</tr>	
					<tr>
						<th>전화번호</th>
			...
			<ul class="dtlBtns">
				<li><button type="submit" class="btnBase01">수정완료</button></li>
				<li><button onclick="location.href='metroCon.do?command=userInfo&id=${dto.id}'" class="btnBase01" type="button">취소</button></li>
			</ul>
		</div>
	</form>
