...
<body style="background-image: url(img/line7.jpg);">
	
	<section style="width: 1900px;">
	<div class="box">
		<div class="img"><img align="left" alt="어린이 대공원" src="img/lineImg/lineSeven-1.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;어린이 대공원<a href="#" onclick="shortestDView('어린이대공원'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			어린이 가족테마공원으로 꿈과 희망이 가득한 도심 속 쉼터!<br>
			동물나라, 자연나라 그리고 놀이동산까지 한 곳에서 다 즐길 수 있습니다.<br>			
			동물 먹이 주기 관람과 체험, 텃밭 체험 등이 가능하며 물놀이를 할 수 있는 수경시설이 있습니다.	<br>
			</p>
		</div>
	...
	<div class="box">
		<div class="img"><img align="right" alt="뚝섬유원지" src="img/lineImg/lineSeven-2.png" class="lineImg"></div>
		<div class="text">
			<h1 class="contentTitle">&nbsp;&nbsp;&nbsp;뚝섬유원지<a href="#" onclick="shortestDView('뚝섬유원지'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent" style="padding-left: 15px;">
			가을에 가기 좋은 곳 한강 뚝섬유원지 나들이<br>
			날씨 좋은 날 가기 좋은 곳으로 빼놓을 수 없는 한강, 한강은 언제가도 좋지만 햇살 좋고 신선한 가을에 가기 참 좋은 곳입니다.
			뚝섬유원지에서 나가면 바로 뚝섬 자벌레를 만나볼 수 있습니다.<br>		
			잔디밭에서 쉴 수 있고 자전거도 탈수 있는 도심속의 휴식처를 찾는다면 뚝섬유원지를 추천합니다! <br>
			</p>
		</div>
	</div>
	
	<div class="box">
		<div class="img"><img align="left" alt="육갑식당" src="img/lineImg/lineSeven-3.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;육갑식당<a href="#" onclick="shortestDView('반포'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			신선한 고기가 먹고 싶다면 육갑식당으로!<br> 
			육갑식당은 당일 배송된 신선한 고기만을 사용합니다.<br>
			평일은 오후 3시에 오픈하고 주말 및 공휴일은 오후 12시에 오픈합니다. 마감은 언제나 새벽 1시 입니다.
			</p>
		</div>
	</div>
