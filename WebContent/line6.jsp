...
<body style="background-image: url(img/line6.jpg);">
	
	<section style="width: 1900px;">
	<div class="box">
		<div class="img"><img align="left" alt="기찻길 산책로" src="img/lineImg/lineSix-1.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;기찻길 산책로<a href="#" onclick="shortestDView('화랑대'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			화랑대역은 일제강점기 당시 물자 수송을 위해 만들어졌으나 이후 경춘선이 개통되면서 공식적으로 폐쇄된 역입니다. 
			서울에서 좀처럼 보기 힘든 간이역의 모습을 즐길 수 있고, 주변에는 기찻길을 활용한 산책로도 있어 가볍게 걷기도 좋습니다.<br>
			화랑대역 4번출구에서 육사방향으로 도보로 8분 정도 걸으면 기찻길 산책로를 만날 수 있습니다.
			</p>
		</div>
	...
	<div class="box">
		<div class="img"><img align="right" alt="신당동 떡볶이 타운" src="img/lineImg/lineSix-2.png" class="lineImg"></div>
		<div class="text">
			<h1 class="contentTitle">&nbsp;&nbsp;&nbsp;대한민국 원조 먹자골목, 신당동 떡볶이 타운<a href="#" onclick="shortestDView('신당'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent" style="padding-left: 15px;">
			며느리도 모르는 맛의 비밀로 유명한 신당동 떡볶이 타운은 1970년대부터 이어진 대한민국 대표 먹자골목입니다.
			자장면에 빠뜨린 떡볶이에서 유래했다는 이곳 신당동 떡볶이는 매콤한 고추장과 달콤한 춘장의 조화가 이색적인 맛을 선사하는 것이 특징인데요,<br> 			
			1인분을 판매하고 있지는 않지만 포장이 가능하며 3인분에 가까운 2인분을 제공하는 만큼 저렴한 가격에 푸짐한 양을 즐길 수 있는 것이 신당동 떡볶이의 매력 포인트!<br>
			</p>
		</div>
	</div>
	
	<div class="box">
		<div class="img"><img align="left" alt="전 골목" src="img/lineImg/lineSix-3.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;막걸리가 생각날 때, 공덕역 전 골목<a href="#" onclick="shortestDView('공덕'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			여행이 끝나갈 무렵 가벼운 막걸리 한 잔이 생각나면 공덕역 전 골목으로 향해보세요. <br>			 
			포장은 물론 식당 내부에서 전을 즐길 수 있고 옆에는 족발 골목까지 자리해 일명 ‘소주파’를 또한 즐기기 좋은 여행지입니다.
			골목이 좁아 이동은 불편하지만 불편한 만큼 느낄 수 있는 전통시장의 매력과 저렴한 가격은 다시금 생각나게 하는 이유가 되기에 충분하답니다. <br>
			입안 가득 고소한 기름기가 도는 튀김과 전에 막걸리 한잔, 어떠세요?<br>	
			</p>
		</div>
	</div>
