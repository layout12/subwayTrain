...
<body style="background-image: url(img/line5.jpg);">
	
	<section style="width: 1900px;">
	<div class="box">
		<div class="img"><img align="left" alt="세종문화회관" src="img/lineImg/lineFive-1.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;세종문화회관<a href="#" onclick="shortestDView('광화문'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			광화문역1,8번 출구로 나오면 서울특별시가 설립한 서울의 대표적인 문화예출기관이 ‘세종문화회관’이 있습니다.
			1978년 개관 이후 2007년 대대적인 리모델링 끝에 세종대극장, 세종M씨어터, 세종체임버홀, 미술관 등 다양한 부대시설을 보유한 복합문화예술센터로서 자리매김하게 되었습니다.<br>
			공연 내적인 분야에서도 세종문화회관 산하 9개 예술단체를 중심으로 전통공연과 클래식, 크로스오버 공연까지 다양한 장르의 공연을 감상할 수 있습니다.
			</p>
		</div>
	...
	<div class="box">
		<div class="img"><img align="right" alt="올림픽공원" src="img/lineImg/lineFive-2.png" class="lineImg"></div>
		<div class="text">
			<h1 class="contentTitle">&nbsp;&nbsp;&nbsp;올림픽공원<a href="#" onclick="shortestDView('올림픽공원'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent" style="padding-left: 15px;">
			올림픽 공원역 3번 출구로 나오면 방대한 올림픽 공원이 나옵니다.<br>
			이곳은 3개 테마공원으로 구분되는데, 첫째는 산책·조깅 코스, 건강지압로, 인라인스케이팅, 레포츠 킥보딩, 엑스게임경기장으로 이루어진 건강올림픽공원이고,
			둘째는 몽촌역사관, 몽촌토성, 평화의 성지, 조각작품공원, 올림픽미술관으로 이루어진 볼거리 올림픽공원,
			셋째는 호돌이 관광열차, 음악분수, 웨딩사진 찍기, 이벤트 광장 등으로 구성된 재미있는 공원으로 자리매김되었습니다.
			</p>
		</div>
	</div>
	
	<div class="box">
		<div class="img"><img align="left" alt="마포원조떡볶이" src="img/lineImg/lineFive-3.png" class="lineImg"></div>
		<div class="text">
		<h1 class="contentTitle">&nbsp;마포원조떡볶이<a href="#" onclick="shortestDView('마포'); return false;"><img alt="지하철" src="img/trainIcon.png" class="titleImg"></a></h1>
		<hr class="boxHr">
			<p class="lineContent">
			마포역 3번출구 서울 가든호텔 뒤쪽에 위치한 분식집입니다.<br>
			가래떡으로 만들어서 식감이 쫄깃하고 진한 양념으로 꾸준히 사랑받는 마포에서 꾸준히 사랑받고 있습니다.<br>
			가격또한 저렴해서 많이 이들이 찾은 유명 맛집입니다.
			</p>
		</div>
	</div>
