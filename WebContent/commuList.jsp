...
<script type="text/javascript">
	...
	$(function(){
		...
		if(row > start+9){
			...
			a.setAttribute("href", "metroCon.do?command=noticeList&role=USER&rowNo="+(start+10));
			a.textContent = ">";
		...
		for(var i=start ; i<=end ; i++){
			...
			if(i == pageNo){
				...
				var a = document.createElement("a");
				a.setAttribute("href", "metroCon.do?command=noticeList&role=USER&rowNo="+i);
				a.textContent = i;
				span.appendChild(a);
			}
	...
	function roleCheck(){
		if("${MySession}" == "" || "${MySession.role}" == "ADMIN"){
			alert("글쓰기 권한이 없습니다.");
		} else {
